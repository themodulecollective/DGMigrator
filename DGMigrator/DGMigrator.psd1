#
# Module manifest for module 'DGMigrator'
#
...
@{
    ...
    GUID                 = '2dd0374b-65e9-45fd-9c5b-6c8c24d79d91'
    ...
    Description          = 'a PowerShell Module for managing Distribution Group Migrations across Exchange Organizations'
    ...
    RequiredModules      = @(
        ...
        @{ModuleName = 'dbaTools'; ModuleVersion = '1.1.23' }
        @{ModuleName = 'ImportExcel'; ModuleVersion = '7.2.2' }
    ...
    FunctionsToExport    = @(
        ...
        'Invoke-DGMGroupTargetAddOperation'
    ...
    PrivateData          = @{
        ...
        PSData = @{
            ...
            Tags       = @('PSModule', 'DistributionGroups', 'Exchange', 'Migration')

            # A URL to the license for this module.
            LicenseUri = 'https://github.com/themodulecollective/DGMigrator/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri = 'https://github.com/themodulecollective/DGMigrator'
